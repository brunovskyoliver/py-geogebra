...
class Point:
    ...
    def draw_point(self):
        self.canvas.create_oval(
            self.screen_x - self.r,
            self.screen_y - self.r,
            self.screen_x + self.r,
            self.screen_y + self.r,
            fill=self.color,
            width=2,
        ...
        if self.label:
            self.canvas.create_text(
                self.screen_x + 10 * self.visual_scale,
                self.screen_y - 15 * self.visual_scale,
                text=self.label,
    ...
    def update(self):
        ...
        self.screen_x, self.screen_y = world_to_screen(self.pos_x, self.pos_y)
